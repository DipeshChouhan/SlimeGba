...
#define SWP_MASK 0x1F000F0
#define SWP_DECODE 0x1000090

#define SWPB_DECODE 0x1400090
...
#define LS_H_D_S_INST_MASK 0x1000F0

#define LDRH_DECODE 0x1000B0
#define LDRSB_DECODE 0x1000D0
#define LDRSH_DECODE 0x1000F0

#define STRH_DECODE 0xB0

#define STRBT_DECODE 0x600000
#define STRT_DECODE 0x200000


#define BX_MASK 0x3F000F0
#define BX_DECODE 0x1200010

#define MRS_MASK 0x3B00000
#define MRS_DECODE 0x1000000

#define MSR_IMM_MASK 0x3B00000
#define MSR_IMM_DECODE 0x3200000

#define MSR_REG_MASK 0x3B000F0
#define MSR_REG_DECODE 0x1200000
